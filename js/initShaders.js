...
// var shaderScript = document.getElementById(id);
 ...
 //  }
  ...
  gl.shaderSource(shader, window[id]);
  gl.compileShader(shader);
...
function createProgram(fragmentShaderID, vertexShaderID) {
  var fragmentShader = getShader(gl, fragmentShaderID, gl.FRAGMENT_SHADER);
  var vertexShader = getShader(gl, vertexShaderID, gl.VERTEX_SHADER);
...
window.setShader = function setShader(name){
