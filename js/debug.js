...
window.setDebugParam = function setDebugParam(){
  //cjh $("#jCount").val(Param.jCount);
...
window.readDebugParam = function readDebugParam(){
  //cjh Param.jCount = parseFloat($("#jCount").val());
